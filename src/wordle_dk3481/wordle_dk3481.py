...
def check_guess(secret_word, guess):
    ...
    Example:
    -------
    check_guess("lello", "hello")
    output: [('h', 'gray'), ('e', 'green'), ('l', 'green'), ('l', 'green'), ('o', 'green')]
    
    check_guess("dream", "crate")
    output: [('c', 'gray'), ('r', 'green'), ('a', 'yellow'), ('t', 'gray'), ('e', 'yellow')]
    """
